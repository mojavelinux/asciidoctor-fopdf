...
-H::
 enables hyphenation. You need to set the lang attribute to a valid country code (which defaults to en for English), e.g.

 asciidoctor -a lang=es -b docbook article.adoc
+
or in the preamble of your `article.doc` file:
